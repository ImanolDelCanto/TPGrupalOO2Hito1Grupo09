...
public class TestConexion {
	...
	public static void main(String[] args) {
		...
		List<FoodTruck> foodtrucks = session.createQuery("from FoodTruck").getResultList();
		List<PuestoDesarmable> puestoDesarmable = session.createQuery("from PuestoDesarmable").getResultList();
		...
		System.out.println("  Foodtruck        : " + foodtrucks.size());
		System.out.println("  Puestodesarmable : " + puestoDesarmable.size());
